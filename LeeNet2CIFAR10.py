...
# leNet5 = LeNet5()
model = LeeNet(inputChannel=3, padding=0)
...
for epoch in range(maxEpoch):
    ...
    if maxAccuracy < (100 * accuracyTotalTest / testSize):
        ...
        torch.save(model, "model/LeeNet/LeeNet2CIFAR10_%s.pth" % (int(maxAccuracy * 100)))
...
dataFrame.to_csv("./log/LeNet/LeeNetCIFAR10/LeeNet2CIFAR10.csv", mode='w', index=None, encoding='utf_8_sig')
